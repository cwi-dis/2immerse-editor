...
export type ADD_ELEMENT_TO_TIMELINE_TRACK = PayloadAction<"ADD_ELEMENT_TO_TIMELINE_TRACK", {chapterId: string, regionId: string, trackId: number, componentId: string}>;
function addElementToTimelineTrack(chapterId: string, regionId: string, trackId: number, componentId: string): ADD_ELEMENT_TO_TIMELINE_TRACK {
  return {
...
export interface TimelineActions extends ActionCreatorsMapObject {
  ...
  addElementToTimelineTrack: (chapterId: string, regionId: string, trackId: number, componentId: string) => ADD_ELEMENT_TO_TIMELINE_TRACK;
}
