...
class Test(unittest.TestCase):
    ...
    def test_put_xml(self):
        ...
        d.loadXml(DOCUMENT.strip())
        x = d.xml()
        path = x.paste('third', 'begin', None, '<thirdChild><thirdGrandChild depth="3" /></thirdChild>', 'application/xml')
    ...
    def test_put_json(self):
        ...
        d.loadXml(DOCUMENT.strip())
        x = d.xml()
        path = x.paste('third', 'begin', 'thirdChild', '{"depth":"2"}', 'application/json')
